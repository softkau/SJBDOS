...
inline bool IsAvailable(MemoryType m_type) {
	return
		m_type == MemoryType::kEfiBootServicesCode ||
		m_type == MemoryType::kEfiBootServicesData ||
		m_type == MemoryType::kEfiConventionalMemory;		
}
